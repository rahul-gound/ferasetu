/**
 * FeraSetu Canonical Plan Configuration
 * =====================================
 * Single source of truth for all plan-related logic, pricing, feature limits,
 * legacy normalization, and A/B pricing experimentation.
 *
 * Tiers:
...
export const PLANS: PlanDefinition[] = [
  {
    ...
    features: [
      ...
      { label: '20 FeraSetu AI credits/month', included: true },
  ...
  },
  {
    ...
    outcome: 'Expand your catalog, track profits, automate stock alerts, and use your FeraSetu AI assistant daily.',
  ...
  },
  {
    ...
    features: [
      ...
      { label: '1,000 FeraSetu AI credits/month', included: true },

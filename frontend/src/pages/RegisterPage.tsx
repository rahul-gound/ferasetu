...
export default function RegisterPage() {
  ...
  const directSignUpUrl = `https://api.workos.com/user_management/authorize?client_id=${clientId}&redirect_uri=${encodeURIComponent(window.location.origin + '/callback')}&response_type=code&screen_hint=sign-up`;
